// polygon_inscribe.h - Inscribed polygons and circles
// Includes: Largest circle in polygon, largest polygon in circle, largest n-gon in polygon

#ifndef POLYGON_INSCRIBE_H
#define POLYGON_INSCRIBE_H
